        ...
        <Layout>
            ...
            <Layout>
                <Sider hide-trigger class="page-left" :class="{houseShow:$route.path==='/houseStatus'}">
                    <Menu ref="contactMenu" :active-name="$route.name" theme="light" width="auto" :accordion="true" :open-names="vexOpenNames?[vexOpenNames]:openNames" @on-select="changeMenu">
                ...
                <Layout id="content">
                    ...
                    <Content class="content" :style="{'padding-bottom':padding}" :class="{delPad:$route.path==='/houseStatus'}">
                        ...
                        <div v-else class="content-bg" :style="{'height':bgheight}">
                            <router-view></router-view>
                        </div>
